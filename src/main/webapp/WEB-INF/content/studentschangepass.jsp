...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
 ...
 <div class="row">
        <div class="col-md-8">
            <form id="defaultForm" name="aspnetForm" method="post" action="changepass" onsubmit="javascript:return WebForm_OnSubmit();" id="aspnetForm">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								...
								<input type="text" name="name" value="${sessionScope.students_name}" id="" class="form-control form-control-inline" placeholder="" disabled  />
							    </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="password" name="password" value="" id="" class="form-control form-control-inline" placeholder="请输入之前的密码" />
							    </div>
							    <label>新密码</label>
                                <div class="form-group">
								<input type="password" name="newpassword" value="" id="" class="form-control form-control-inline" placeholder="请输入新密码" />
							    </div>
							</div>
					</div>                                     
