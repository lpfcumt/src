...
<head><title>
  ...
  <style>
            ...
            ul.nav.navbar-nav.navbar-right.a {
	            color:#2D194B !important; /* EMS_UI_PRIMARY_COLOR */
            }
            ...
            .navbar-inverse {
                background-color: #FFF  !important; /* EMS_UI_PRIMARY_COLOR */
            ...
            .navbar-inverse .navbar-nav > .active > a, .navbar-inverse .navbar-nav > .active > a:hover, .navbar-inverse .navbar-nav > .active > a:focus, .navbar-inverse .navbar-nav > .open > a, .navbar-inverse .navbar-nav > .open > a:focus{
                background-color: #ADADAD !important; /* EMS_UI_SECONDARY_COLOR */
            }
            ...
            .panel-heading .nav > li.active > a {
	            color: #ADADAD  !important;  /* EMS_UI_PRIMARY_COLOR */
            }

            .panel-heading .nav > li.active > a, .panel-heading .nav > li > a:hover {
	            color: #ADADAD !important;  /* EMS_UI_SECONDARY_COLOR */
            }

            .profile-nav ul > li > a:hover, .profile-nav ul > li > a:focus, .profile-nav ul li.active a {
	            background: #ADADAD !important;
	            border-left: 5px solid #FFF ;   /* EMS_UI_PRIMARY_COLOR */
	            color: #ADADAD !important;  /* Black color used for all sites */
            }
            ...
            .form-signin h2.form-signin-heading {
                ...
                padding:20px 15px;
                text-align: center;
	            background:#FFF ; /* EMS_UI_PRIMARY_COLOR */
            ...
            .badge.bg-primary {
            background: #FFF  !important; /* EMS_UI_PRIMARY_COLOR */
            }
...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
	...
	<li  class="active"><a href="ListactiveExperiments3"><span style="color:white;">有效实验</span></a></li>
		...
		<div class="col-lg-12">
		 <section class="panel"> 
			<ul class="nav nav-tabs" role="tablist" id="myTab">
                <li role="presentation" class="active" style="font-size: 14px"><a href="#active" role="tab" data-toggle="tab" >有效实验</a></li>
            </ul>
            <br> 
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="active">
                    <table class="table table-hover table-bordered table-striped " id="table2">
				        ...
				        <tbody>
				        <c:forEach items="${sessionScope.listactiveexperiments}" var="listallexperiment1">		
					       <tr id="tr1">
					       <c:if test="${listallexperiment1.cate=='现场现金实验'}">
						      <td style= "text-align:center;">
							     <a target="_blank" href="ListOneExperiments2?id=${listallexperiment1.id}" id="a1"><span id="span1">${listallexperiment1.name}</span></a><br>
						     ...
						     <c:if test="${listallexperiment1.cate=='在线实验'}">
						      ...
						      <td style= "text-align:center;">
							     <a target="_blank" href="ListOneExperiments2?id=${listallexperiment1.id}" id="a2">实验信息</a><br>
						      </td>
					       </tr>
					    </c:forEach>
				        </tbody>
