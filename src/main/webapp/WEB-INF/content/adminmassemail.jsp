...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
	<li ><a href="adminmain"><span  class="glyphicon glyphicon-home"></span>&nbsp;<span >主页</span></a></li>
 ...
 <div class="row">
      ...
      <div class="panel">
            <div>
            <br>
                 <p style="font-size:17px;">&nbsp;&nbsp;&nbsp;&nbsp;群发邮件</p>
                <hr class="hrhr" />
                <p style="font-size:14px;font-family:微软雅黑;">&emsp;&emsp;&emsp;&emsp;<small>此步骤您需要指定邮件的一些基本信息，诸如主题、内容。</small></b>
                        <hr class="hrhr"/>
            </div>
			<form class="form-horizontal"  id="defaultForm" action="massEmail" method="post">
                <div class="form-group">
                     <label for="inputPassword3" class="col-sm-2 control-label " style="text-align:center"><p style="font-size:16px;">邮件主题</p></label>
                     <div class="col-sm-6">
                           <input type="text" id="subject" name="subjec" class="form-control" id="inputPassword3" placeholder="" maxlength="100" required="required" />
                ...
                <hr class="hrhr">                
                <div class="form-group">
                     <label for="inputPassword3"class="col-sm-2 control-label " style="text-align:center"><p style="font-size:16px;">详细内容<br></p></label>
                     <div class="col-sm-6">
                           <textarea name="content" id="content" class="form-control" rows="12" minlength="1" maxlength="1000"></textarea>
                     </div>
                </div>
                <hr class="hrhr">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" id="btn1" class="btn btn-primary"  onclick="return checkForm(this)" value="发送">发送</button>
                    </div>
                </div>
            </form>
		</div>
