...
public interface ExperimentsDao extends BaseDao<Experiments>{
	...
	List<Experiments_Front> lisfront(int id);
	...
	void updateExperiments(int id, Double pay, Double credit, String detail, String url);
	...
	void completeStudents(int id, int students_id);
	...
	List<Experiments> listByStarttime(String starttime);

	List<Students> listjoinstudentsById(List<Experiments> experiments);

	List<Experiments_unjoinstudents> listunjoinstudentById(int id);

	List<Students> listcanjoinstudents(int id, List<Experiments_joinstudents> list2);
	...
	List<Object[]> countPay(int id, List<Experiments> listExperiment);

	List<Object[]> countCredit(int id, List<Experiments> listExperiment);
}
