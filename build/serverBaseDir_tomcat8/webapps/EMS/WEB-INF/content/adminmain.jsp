...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
	<li class="active"><a href="adminmain"><span style="color:white" class="glyphicon glyphicon-home"></span>&nbsp;<span style="color:white;">主页</span></a></li>
            ...
            <div class="col-sm-6">
                <section class="panel">
                    ...
                    <div class="list-group">
                        <a href="ListAllExperiments4" id="ctl00_ContentPlaceHolder1_lnkAllStudies_Researcher" class="list-group-item"><span class="glyphicon glyphicon-paperclip"></span>&nbsp;&nbsp;查看所有实验</a>
                    </div>
                </section>

                <section class="panel">
                    <header class="panel-heading">
                        <span id="ctl00_ContentPlaceHolder1_lblAddNewStudy" style="font-family:SimHei">教师信息</span>
                    </header>
                    <div class="list-group">
                        <a href="adminteachersinfo" id="ctl00_ContentPlaceHolder1_lnkAddNewStudy" class="list-group-item"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;查看教师信息</a>
                    </div>
                </section>
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <span id="ctl00_ContentPlaceHolder1_lblMyProfile_Researcher" style="font-family:SimHei">学生信息</span>
                    </header>
                    <div class="list-group">
                        <a href="Adminstudentsinfo" id="ctl00_ContentPlaceHolder1_lnkMyProfile1_Researcher" class="list-group-item"><span class="glyphicon glyphicon-lock"></span>&nbsp;&nbsp;查看学生信息</a>
                    </div>
                </section>
                <section class="panel">
                    <header class="panel-heading">
                        <span id="ctl00_ContentPlaceHolder1_lblMyProfile_Researcher" style="font-family:SimHei">群发邮件</span>
                    </header>
                    <div class="list-group">
                        <a href="adminmassemail" id="ctl00_ContentPlaceHolder1_lnkMyProfile1_Researcher" class="list-group-item"><span class="glyphicon glyphicon-lock"></span>&nbsp;&nbsp;发送邮件给所有学生</a>
                    </div>
                </section>
...
<div id="ctl00_ContentPlaceHolder1_upcomingAppointmentsUpdatePanel">
                 ...
                 <section class="panel">
                    ...
                    <div class="list-group">       
                        		<c:forEach items="${sessionScope.listactiveexperiments}" var="listactiveexperiments">
                                <a href="ListOneExperiments4?id=${listactiveexperiments.id}" id="ctl00_ContentPlaceHolder1_MostRecentStudiesRepeater_Researcher_ctl00_lnkStudy" class="list-group-item">
                                   ${listactiveexperiments.name}<span class="badge pull-right bg-primary">${listactiveexperiments.createtime}</span>                                
                                </a>
