                ...
                <section class=" wrapper site-min-height">
                    <div class="row">
						...
						<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
							...
							<li  class="active"><a href="ListAllExperiments4">所有实验</a></li>
				...
				<table class="table table-bordered table-striped">
					...
					<c:forEach items="${sessionScope.listoneexperiments}" var="listoneexperiments">				
						<tr>
							...
							<td>
								<input name="" type="text" readonly="readonly" class="form-control sona-autoselect"  onclick="window.open('${listoneexperiments.url}')"  value="${listoneexperiments.url}" />
								<span class="help-block">1这是参与实验的链接，你可能在向学生发送邮件或发布公告时用到。</span>
							</td>
						</tr>
					</c:forEach>	
					</tbody>
