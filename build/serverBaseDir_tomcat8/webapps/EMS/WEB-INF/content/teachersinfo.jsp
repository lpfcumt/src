...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
							...
							<li class="active"><a href="ListTeachersInfo" target="_blank"><span style="color:white;">个人信息</span></a></li>
...
<div class="row">
		<div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    <span id="ctl00_ContentPlaceHolder1_lblTableTitle" style="font-family:SimHei;font-size:20px">教师个人信息</span>
                </header>
                <div class="panel-body">
                <c:forEach items="${sessionScope.listteachersinfo}" var="listteachersinfo">
                   <div class="row">&nbsp;</div>
                    <div class="row">&nbsp;</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								...
								<input type="text" name="name" value="${listteachersinfo.name}" id="" class="form-control form-control-inline" placeholder="" disabled />
							    </div>
                            </div>
				    ...
				    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="id" value="${listteachersinfo.sex}" id="" class="form-control form-control-inline" placeholder="" disabled/>
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="id" value="${listteachersinfo.teachers1_id}" id="" class="form-control form-control-inline" placeholder="" readonly/>
							    </div>
							</div>
					</div>  
				     <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="school" value="${listteachersinfo.school}" id="" class="form-control form-control-inline" placeholder="" disabled />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="tel" value="${listteachersinfo.tel}" maxlength="11" id="" class="form-control form-control-inline" placeholder="" disabled />
							    </div>
							</div>
					</div>                                       
					<div class="row">
							...
							<div class="control-label col-md-6">
                                <div class="form-group">
								<input name="email" type="email" value="${listteachersinfo.email}" maxlength="30" id="" class="form-control form-control-inline" placeholder="" disabled />
                                </div>
							</div>
				    ...
				    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="password" value=""  id="password" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>                                       
					<div class="row">
							...
							<div class="control-label col-md-6">
                                <div class="form-group">
								<input type="password" value=""  id="newpassword" class="form-control form-control-inline" placeholder="" />
                                </div>
							</div>
				    ...
				    <div class="row">
				    	<div class="control-label col-md-12">
				    	 <input type="button" id="btn1" class="btn btn-default btn-sm" onClick="return updatepassword()" value="修改密码">
				   		</div>
				    </div>
                </c:forEach>
    ...
    <script>
    	function updatepassword(){
    		...
    		$.ajax({
    			   url:'UpdateTeachersPassword',// 跳转到 action  
    			   data:{  
