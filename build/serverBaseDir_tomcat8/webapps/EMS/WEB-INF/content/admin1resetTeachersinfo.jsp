...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
	...
	<li><a href="return_Exitmain">退出登录&nbsp;<span class="glyphicon glyphicon-log-out"></span></a></li>
                    ...
                    <!-- page start--> 
       <c:forEach items="${sessionScope.listTeachersById}" var="listTeachersById1">	             
    <div class="row">
        <div class="col-md-12">
            <form   method="post" action="reset1Teachers"  >
            <section class="panel">

                <header class="panel-heading">
                    <span id="ctl00_ContentPlaceHolder1_lblTableTitle" >查看、修改教师信息</span>
                </header>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								...
								<input type="text" name="name" value="${listTeachersById1.name}" id="" class="form-control form-control-inline" placeholder=""  />
							    </div>
                            </div>
                   ...
                   <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="sex" value="${listTeachersById1.sex}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="id" value="${listTeachersById1.teachers1_id}" id="" class="form-control form-control-inline" placeholder="" readonly/>
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="password" name="password" value="${listTeachersById1.password}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                 <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="password" name="repassword" value="${listTeachersById1.repassword}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                     <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="school" value="${listTeachersById1.school}" id="" class="form-control form-control-inline" placeholder=""  />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="tel" value="${listTeachersById1.tel}" maxlength="11" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>                                       
					<div class="row">
							...
							<div class="control-label col-md-6">
                                <div class="form-group">
								<input name="email" type="email" value="${listTeachersById1.email}" maxlength="30" id="" class="form-control form-control-inline" placeholder=""  />
                                </div>
							</div>
					...
					<div class="row">
						<div class="form-group">
							<div class="control-label col-md-12">
								<br><br><input type="submit" name="保存教师信息" value="保存教师信息" onclick="disp_alert()" id="" class="btn btn-info btn-lg" />
							</div>
						</div>
					</div>
                </div>
