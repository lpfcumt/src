...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
	...
	<li><a href="return_Exitmain">退出登录&nbsp;<span class="glyphicon glyphicon-log-out"></span></a></li>
                    ...
                    <!-- page start-->
       <c:forEach items="${sessionScope.listStudentsById}" var="listStudentsById1">	             
    <div class="row">
        <div class="col-md-12">
            <form id="defaultForm"  method="post" action="reset1Students" >
            <section class="panel">

                <header class="panel-heading">
                    <span id="ctl00_ContentPlaceHolder1_lblTableTitle">学生个人信息</span>
                </header>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								...
								<input type="text" name="name" value="${listStudentsById1.name}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
                            </div>
                   ...
                   <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="sex" value="${listStudentsById1.sex}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text"  value="${listStudentsById1.students_id}" id="" class="form-control form-control-inline" placeholder=""  readonly/>
								<input type="hidden" name="id" value="${listStudentsById1.id}">
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="password" name="password" value="${listStudentsById1.password}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
					<div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="password" name="repassword" value="${listStudentsById1.repassword}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="grade" value="${listStudentsById1.grade}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="major" value="${listStudentsById1.major}" id="" class="form-control form-control-inline" placeholder="" />
							    </div>
							</div>
					</div>
                     <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="school" value="${listStudentsById1.school}" id="" class="form-control form-control-inline" placeholder=""  />
							    </div>
							</div>
					</div>
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="tel" value="${listStudentsById1.tel}" maxlength="11" id="" class="form-control form-control-inline" placeholder=""  />
							    </div>
							</div>
					</div>                                       
					<div class="row">
							...
							<div class="control-label col-md-6">
                                <div class="form-group">
								<input name="email" type="email" value="${listStudentsById1.email}" maxlength="30" id="" class="form-control form-control-inline" placeholder="" />
                                </div>
							</div>
					...
					<div class="row">
						<div class="form-group">
							<div class="control-label col-md-12">
								<br><br><input type="submit" name="保存学生信息" value="保存学生信息" onclick="disp_alert()" id="" class="btn btn-info btn-lg" />
							</div>
						</div>
					</div>
                </div>
             ...
             <footer class="site-footer">
                <div class="text-center">
                    <address>
                        ...
                        Copyright &copy; <span id="ctl00_YearLabel">2017</span>&nbsp;<a href="http://sm.xmu.edu.cn/" target="_blank">SM.XMU.Edu</a>                    </address>
                </div>
            </footer>
            <!--footer end-->
        </section>
