...
<body class="boxed-page">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="defaultForm" name="aspnetForm" method="post" action="Forgetpass" onsubmit="javascript:return WebForm_OnSubmit();">
            <section class="panel">

                <header class="panel-heading">
                    <span id="ctl00_ContentPlaceHolder1_lblTableTitle">学生忘记密码</span>
                </header>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								...
								<input type="text" name="name"  id="name" class="form-control form-control-inline"  placeholder="您的姓名" />
							    </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="tel" maxlength="11" id="tel" class="form-control form-control-inline" placeholder="您的电话" />
							    </div>
							</div>
					</div>          
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="students_id"  id="students_id" class="form-control form-control-inline" placeholder="您的学号" />
							    </div>
							</div>
					</div>                                  
					<div class="row">
							...
							<div class="control-label col-md-6">
                                <div class="form-group">
								<input name="email" type="email" maxlength="30" id="email" class="form-control form-control-inline" placeholder="您的邮箱" />
                                </div>
							</div>
					...
					<div class="row">
						<div class="form-group">
							<div class="control-label col-md-12">
								<br><br><input type="submit" name="" value="找回密码" onclick="return check()" id="" class="btn btn-info btn-lg" />
							</div>
						</div>
					</div>
                </div>
...
function check(){
	...
	$.ajax({
		url:"Forgetpass",
		data:{name:name,tel:tel,students_id:students_id,email:email},
		type:'post',
		cache:false,
		dataType:'json',
		success:function(data){
			if(data.flog==false){
				alert("对不起，您输入的信息有误，请确认后再输入！");
			}
			else{
				alert("找回密码成功！ 您的密码已发送至您的邮箱，请注意查收。");
