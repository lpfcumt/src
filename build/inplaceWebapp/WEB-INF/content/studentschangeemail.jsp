...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
 ...
 <div class="row">
        <div class="col-md-8">
            <form id="defaultForm" name="aspnetForm" method="post" action="changeemail" onsubmit="javascript:return WebForm_OnSubmit();" id="aspnetForm">
            <section class="panel">

                <header class="panel-heading">
                    <span id="ctl00_ContentPlaceHolder1_lblTableTitle" style="font-family:SimHei;font-size:20px">学生个人信息修改</span>
                </header>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								...
								<input type="text" name="name" value="${sessionScope.students_name}" id="" class="form-control form-control-inline" disabled  />
							    </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="control-label col-md-2">
							...
							<div class="control-label col-md-6">
								<div class="form-group">
								<input type="text" name="" value="${sessionScope.students1_id}" id="" class="form-control form-control-inline" readonly/>
								<input type="hidden" name="id" value="${sessionScope.students_id}">
							    </div>
							</div>
					</div>
					...
					<div class="row">
							...
							<div class="control-label col-md-6">
                                <div class="form-group">
								<input name="email" type="email" value="" maxlength="30" id="" class="form-control form-control-inline" placeholder="请输入您以前的邮箱" />
                                </div>
                                <div class="form-group">
								<input name="newemail" type="email" value="" maxlength="30" id="" class="form-control form-control-inline" placeholder="请输入您的新邮箱" />
                                </div>
							</div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <input type="submit" value="修改" class="btn btn-success btn-lg"/>
                        </div>
                    </div>
