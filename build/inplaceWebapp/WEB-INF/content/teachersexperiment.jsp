...
<ul class="nav navbar-default nav-pills nav-justified" style="font-size:16px;">
	...
	<li class="active"><a href="ListAllExperiments2"><span style="color:white;">所有实验</span></a></li>
				        ...
				        <c:forEach items="${sessionScope.listallexperiment1}" var="listallexperiment1">		
					       ...
					       <c:if test="${listallexperiment1.cate=='现场现金实验'}">
						      <td style= "text-align:center;">
							     <a target="_blank" href="ListOneExperiments?id=${listallexperiment1.id}" id="a1"><span id="span1">${listallexperiment1.name}</span></a><br>
						     ...
						     <c:if test="${listallexperiment1.cate=='在线实验'}">
						      ...
						      <td style= "text-align:center;">
							     <a target="_blank" href="ListOneExperiments?id=${listallexperiment1.id}" id="a2">实验信息</a><br>
						      </td>
					       </tr>
					    </c:forEach>
				        </tbody>
