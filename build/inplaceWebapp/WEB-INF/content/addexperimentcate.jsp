...
<div class="row">
		  ...
		  <div class="col-md-12">
                <div class="panel">
                 ...
                 <br>
                         <p style="font-size:17px;">&nbsp;&nbsp;选择实验类型</p>
                        <hr class="hrhr"/>
                        <p style="font-size:16px;font-family:微软雅黑;">&emsp;&emsp;&emsp;&emsp;<small>创建一个新实验，你必须先制定实验类型。当实验创建之后，你将无法修改实验类型。请确认你要选择的实验类型。</small></b>
                        <hr class="hrhr"/>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                               <div class="radio">
                                    <label for="inputPassword3" class="control-label " style="text-align:left"><p style="font-size:17px;"><b>现场学分实验</b><br><br><span style="color:grey;font-size:15px;">创建一个现场学分实验，您需要指定支付学分</span></p></label><br><br>
                                   <div class="col-sm-4"></div>                                  
                                    <a class="btn btn-primary " href="ChooseExperimentsCate?cate=现场学分实验">继续<span class="glyphicon glyphicon-chevron-right"></span></a>
                               </div>
                            </div>
                        </div>
                        <hr class="hrhr">
                                                <div class="form-group">
                            <div class="col-sm-2">
                                <img src="images/Two-Part Standard Study.JPG" alt="Standard Study"/>
                            </div>
                            <div class="col-sm-10">
                               <div class="radio">
                                    <label for="inputPassword3" class="control-label " style="text-align:left"><p style="font-size:17px;"><b>现场现金实验</b><br><br><span style="color:grey;font-size:15px;">创建一个现场现金实验，您需要指定支付金额</span></p></label><br><br>
                                   <div class="col-sm-4"></div>                                  
                                    <a class="btn btn-primary " href="ChooseExperimentsCate?cate=现场现金实验">继续<span class="glyphicon glyphicon-chevron-right"></span></a>
                               </div>
                            </div>
                        </div>
                        <hr class="hrhr">
                        <div class="form-group">
                            <div class="col-sm-2">
                                <img src="images/Online Survey Study.JPG" alt="Standard Study"/>
                            </div>
                            <div class="col-sm-10">
                               <div class="radio">
                                    <label for="inputPassword3" class="control-label " style="text-align:left"><p style="font-size:17px;"><b>在线实验</b><br><br><span style="color:grey;font-size:15px;">创建一个在线实验</span></p></label><br><br>
                                    <div class="col-sm-4"></div>                                  
                                   <a class="btn btn-primary" href="ChooseExperimentsCate?cate=在线实验">继续<span class="glyphicon glyphicon-chevron-right"></span></a>
                               </div>
                            </div>
                       </div>
                 </form>
