                ...
                <div class="panel-body">
                    <div class="form-signin">
                        ...
                        <div class="login-wrap">
                            ...
                            <label>用户名</label>
                            <input name="students_id" type="text" maxlength="16" size="25" id="id" class="form-control" autofocus placeholder="请输您的学工号" />
                            </div>
                            <div class="form-group">
                            <label>密码</label>
...
function checkForm(){
	...
	if(val1!=null){
		...
		$.ajax({
			   ...
			   data:{  
				   teachers1_id : teachers_id,password : teachers_password  
			    }, 
			    type:'post',  
			    cache:false,  
			    dataType:'json',  
		...
		$.ajax({
			   ...
			   data:{  
				   students_id : students_id,password : students_password  
			    }, 
			    type:'post',  
			    cache:false,  
			    dataType:'json',  
			    success:function(data) { 
			    	...
			    	if(data.flag==false){
			    		...
			    		window.location = 'ListStudentsResent';
				    	return true;}
			     }
